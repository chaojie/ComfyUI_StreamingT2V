...
@dataclass
class TransformerTemporalCrossAttentionModelOutput(BaseOutput):
    """
    Args:
...
class TransformerTemporalCrossAttentionModel(ModelMixin, ConfigMixin):
    """
    ...
    def forward(
        ...
        return TransformerTemporalCrossAttentionModelOutput(sample=output)
