...
def init_streamingt2v_model(ckpt_file, result_fol,vram_not_enough):
    ...
    config_file = f"{comfy_path}/custom_nodes/ComfyUI_StreamingT2V/configs/text_to_video/config.yaml"
    sys.argv = sys.argv[:1]
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        sys.argv.append("--config")
        sys.argv.append(f"{comfy_path}/custom_nodes/ComfyUI_StreamingT2V/configs/inference/inference_long_video.yaml")
